...
*/
              ...
              InkWell(
                onTap: () async {
                  ...
                  userEntity.cities = selectedCities;
                  applyCitiesModifications();
                },
                child: Container(
                  height: 50,
                  width: width,
                  ...
                  child: Wrap(
                    ...
                    children: selectedCities.map((city) => InkWell(
                      onTap: () async {
                        ...
                        userEntity.cities = selectedCities;
                        await applyCitiesModifications();
                      },
                      child: Container(
                        decoration: BoxDecoration(
                            color: AppTheme.baseColor,
  ...
  void _resetValues() {
    ...
    if(userEntity != null) {
      ...
      selectedCities = userEntity.cities;
      if(this.mounted)
        setState(() {
  ...
  void applyCitiesModifications() async {
    Utils.showCustomHud(context);
    bool success = await UserHandler().updateUser(userEntity);
    Utils.hideCustomHud(context);
    if (!success) {
