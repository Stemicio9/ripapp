...
class AdminCreateDemisePage extends StatefulWidget {
  @override
  _AdminCreateDemisePageState createState() => _AdminCreateDemisePageState();
}

class _AdminCreateDemisePageState extends State<AdminCreateDemisePage> {
                 ...
                 /*   SizedBox(height: 20),
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              ...
                              textAlign: TextAlign.left,
                              style: TextStyle(
                                color: age != null ? AppTheme.almostBlack : Colors.black.withOpacity(0.5),
                                fontSize: 18.0,
                                fontWeight: FontWeight.normal,
                              ),
                            ),
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        Utils.unfocusTextField(context);
                      },
                      child: Container(
                        height: 30,
                        width: width,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  path.basename(this.document.path),
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: AppTheme.grey,
                                    fontSize: 16.0,
                            ...
                            SizedBox(height: document != null ? 20 : 0),
                            document != null ?
                            Padding(
                              padding: EdgeInsets.symmetric(horizontal: 20),
                              child: Row(
                    ...
                    TextField(
                      ...
                      onEditingComplete: () => wakeNotesNode.requestFocus(),
                      //onSubmitted: (val) => wakeNotesNode.requestFocus(),
                    ),
                    Divider(
                      thickness: 0.5,
                      color: AppTheme.almostBlack,
                    ...
                    TextField(
                      ...
                      onEditingComplete: () => funeralNotesNode.requestFocus(),
                    ),
                    Divider(
                      thickness: 0.5,
                      color: AppTheme.almostBlack,
  ...
  void _saveDemise() async {
    if(/*defunctPhoneController.text.isEmpty || */nameController.text.isEmpty || lastnameController.text.isEmpty
    ...
    if(document == null) {
      Utils.showErrorSnackBar(MyLocalizations.of(context, "insert_pdf_obituary"), context: context);
      return;
    }
    ...
    String demiseUuid = Uuid().v4();
    String docUrl;
    Utils.showCustomHudLong(context);
    if(document != null) {
      Reference ref = FirebaseStorage.instance.ref().child("obituary_pdfs").child(demiseUuid);
    ...
    String photoUrl;
    if(imageFile != null) {
      photoUrl = await Utils.savePhotoToFirebase(Configuration.DEMISE_PHOTOS, demiseUuid, imageFile);
    }
    double lat;
    double lon;
    ...
    DemiseEntity createDemiseEntity = DemiseEntity(
          ...
          //cemeteryName: livingCityNameController.text.isNotEmpty ? livingCityNameController.text : null,
          cityName: livingCity != null ? livingCity.name : null,
    ...
    bool success = await DemisesManager().createDemise(createDemiseEntity);
    Utils.hideCustomHudLong(context);
    if(!success)
      Utils.showErrorSnackBar(MyLocalizations.of(context, "cannot_create_demise"), context: context);
    else {
      Navigator.of(context).pop();
      Utils.showOkSnackBar(MyLocalizations.of(context, "demise_created"));
    }
  ...
  Widget _buildRelativeDetails(RelativeEntity relativeEntity) {
    return ParentBox(relativeEntity, relatives);
  }
...
class ParentBox extends StatefulWidget {
  final List<RelativeEntity> relatives;
  final RelativeEntity relativeEntity;

  ParentBox(this.relativeEntity, this.relatives);
...
class _ParentBoxState extends State<ParentBox> {
  ...
  Widget build(BuildContext context) {
    ...
    relativePhoneController.value = TextEditingValue(text: widget.relativeEntity.phone ?? "");
          ...
          children: [
            ...
            Align(
              ...
              child: DropdownButton<Kinship>(
                ...
                value: widget.relativeEntity.kinship,
                onChanged: (Kinship value) {
                  setState(() {
                    widget.relativeEntity.kinship = value;
                  });
                },
                ...
                Container(
                  ...
                  child: Theme(
                    ...
                    child: DropdownButton<String>(
                      ...
                      value: widget.relativeEntity.prefix != null ? widget.relativeEntity.prefix : DEFAULT_PREFIX,
                      onChanged: (value) {
                        setState(() {
                          widget.relativeEntity.prefix = value;
                        });
                      },
                    ),
                  ),
                ...
                Expanded(
                  child: TextField(
                    ...
                    onChanged: (val) {
                      ...
                      widget.relativeEntity.phone = val;
            ...
            usersFound.isNotEmpty ? Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: usersFound.map((e) => _buildUser(e, widget.relativeEntity)).toList()
                ),
              ),
            ) : SizedBox(),
            Divider(
            ...
            Container(
              ...
              child: RoundedButton(MyLocalizations.of(context, "remove_relative"), Colors.white, Colors.red, () {
                setState(() {
                  widget.relatives.remove(widget.relativeEntity);
                });
              }),
            ),
          ],
            ...
            Container(
              ...
              child: RoundedButton(
                MyLocalizations.of(context, "select"), Colors.white, AppTheme.baseColor,
                  ...
                  setState(() {
                    relativeEntity.phone = e.phone;
                    relativeEntity.accountId = e.accountid;
                    usersFound = [];
                  });
                },
                verticalPadding: 0,
