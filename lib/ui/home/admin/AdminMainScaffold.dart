...
import 'package:ripapp/ui/home/admin/AdminDemisesPage.dart';
...
class AdminMainScaffold extends StatefulWidget {
  ...
  AdminMainScaffold({this.currentPage});

  @override
  _AdminMainScaffoldState createState() => _AdminMainScaffoldState();
}
...
class _AdminMainScaffoldState extends State<AdminMainScaffold> {
  ...
  List<Widget> pages = [AdminDemisesPage(), AdminProfilePage()];
  ...
  _buildChildren() {
    var builder = [
      ...
      _buildTab("assets/bottom_nav_bar/profile.png", MyLocalizations.of(context, "profile"), 1)
    ];
    return builder;
  }
