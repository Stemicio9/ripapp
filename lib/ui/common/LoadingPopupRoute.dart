...
class LoadingPopupRoute extends PopupRoute {
  static LoadingPopupRoute instance;
  ...
  static void show(BuildContext context) {
    if (instance != null)
      return;
    try {
      LoadingPopupRoute hud = LoadingPopupRoute();
      instance = hud;
      Navigator.push(context, hud);
      timer = Timer(Configuration.LOADING_TIMEOUT, () {
        if(instance != null)
